    ...
    <div className="relative">
      ...
      <div className="mt-1 relative rounded-md shadow-sm">
        <input
          ...
          className={`${inputClassName} block w-full px-1 py-2 pr-10 rounded-md ${
            errors.phone ? 'border-status-error' : 'border-background-dark'
          } focus:outline-none focus:ring-1 focus:ring-primary-light focus:border-primary`}
        />
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pointer-events-auto pr-3">
          <div className="group relative">
            ...
            <div className="absolute hidden group-hover:block right-0 bottom-full mb-2 w-48 bg-background-dark text-text-light text-xs rounded py-1 px-2 shadow-lg">
