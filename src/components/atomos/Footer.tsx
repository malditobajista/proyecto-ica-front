          ...
          <nav>
            ...
            {navLinks.map((link, index) => (
              <Link
                key={index}
                to={link.to}
                className="block hover:text-secondary-light transition-colors duration-300 mb-2"
              >
                {link.text}
              </Link>
            ))}
                ...
                <p className="text-sm">
                  {info.href ? (
                    <a
                      ...
                      className="hover:text-accent-light hover:underline transition-colors duration-300"
                    >
                      {info.content}
                    </a>
                  ) : (
